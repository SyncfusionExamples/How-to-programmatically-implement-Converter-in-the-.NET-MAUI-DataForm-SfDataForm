# How to programmatically implement Converter in the .NET MAUI DataForm (SfDataForm)

This repository contains the sample code to programmatically implement Converter in the [SfDataForm](https://help.syncfusion.com/maui/dataform/getting-started).
